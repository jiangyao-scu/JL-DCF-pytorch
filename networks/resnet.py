...
class JLModule(nn.Module):
        ...
        def load_pretrained_model(self, model_path):
            ...
            # self.resnet.load_state_dict(model_path, strict=True)
            # pretrained_dict = model_path
            # del self.resnet.fc
            self.vgg_conv1.load_state_dict(torch.load('dataset/pretrained/vgg_conv1.pth'), strict=True)
